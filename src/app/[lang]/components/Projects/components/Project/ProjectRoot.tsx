...
export default function ProjectRoot({ children }: ProjectRootProps) {
  return (
    <div className="relative flex flex-col gap-2 bg-white rounded-lg px-6 py-3 w-[350px] mt-4 items-center group cursor-pointer group shadow-lg lg:w-[450px] sm:w-[300px]">

...
export default function Footer() {
  return (
    <footer className="flex justify-between items-end mt-auto w-full h-24 pb-3 bg-gradient-to-r from-amaranth-800 to-amaranth-500 px-40 text-white font-light text-xl lg:px-10 lg:text-lg md:px-5 xl:px-20">
      <Personal.Root>

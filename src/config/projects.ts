...
export const generateProjectsConfig = async ({ lang }: { lang: Locale }) => {
  ...
  const config = {
    ...
    projects: [
      {
        title: projectsSection.projects.futuresPocketTrader.title,
        description: projectsSection.projects.futuresPocketTrader.description,
        about: projectsSection.projects.futuresPocketTrader.about,
        imageHref: '/images/project_futures_pocket_trader.png',
        imageAlt: projectsSection.projects.futuresPocketTrader.imageAlt,
        appHref: 'https://www.futurespockettrader.com',
        repositoryHref: 'https://github.com/lorenzoa7/futures-pocket-trader',
        createdAt: projectsSection.projects.futuresPocketTrader.createdAt,
        features: projectsSection.projects.futuresPocketTrader.features,
        techKeys: [
          'typescript',
          'nextjs',
          'react',
      ...
      {
        title: projectsSection.projects.pesquisaFipe.title,
        description: projectsSection.projects.pesquisaFipe.description,
        about: projectsSection.projects.pesquisaFipe.about,
        imageHref: '/images/project_pesquisafipe.png',
        imageAlt: projectsSection.projects.pesquisaFipe.imageAlt,
        appHref: 'https://www.pesquisafipe.com.br',
        repositoryHref: 'https://github.com/lorenzoa7/pesquisa-fipe',
        createdAt: projectsSection.projects.pesquisaFipe.createdAt,
        features: projectsSection.projects.pesquisaFipe.features,
        techKeys: [
          'typescript',
          'nextjs',
          'react',
      ...
      {
        title: projectsSection.projects.futuresPocketTraderNative.title,
        description:
          projectsSection.projects.futuresPocketTraderNative.description,
        about: projectsSection.projects.futuresPocketTraderNative.about,
        imageHref: '/images/project_futures_pocket_trader_native.png',
        imageAlt: projectsSection.projects.futuresPocketTraderNative.imageAlt,
        repositoryHref:
          'https://github.com/lorenzoa7/futures-pocket-trader-native',
        createdAt: projectsSection.projects.futuresPocketTraderNative.createdAt,
        features: projectsSection.projects.futuresPocketTraderNative.features,
        techKeys: [
          'typescript',
          'electron',
          'react',
